        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 text-right mb-2">
                    <a href="{{ route('admin.slider.get') }}" class="btn btn-primary"><i class="fa fa-plus"></i>Add
                        new</a>
                </div>
                                ...
                                <table id="zero_config" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($sliders as $slider)
                                            <tr>
                                                <td>{{ $slider->head_text }}</td>
                                                <td>{{ $slider->para_text }}</td>
                                                <td><img src="{{ Storage::url($slider->image) }}" alt=""
                                                        height="75">
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.slider.delete', [$slider->id]) }}"><i
