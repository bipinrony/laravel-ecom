            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form-horizontal" action="{{ route('admin.slider.update') }}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="head_text" value="{{ $slider->head_text }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="name"
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="para_text" value="{{ $slider->para_text }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <img src="{{ Storage::url( $slider->image ) }}" alt="" width="75">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="status"
