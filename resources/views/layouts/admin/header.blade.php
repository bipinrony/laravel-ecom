        ...
        <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="index.html">
                ...
                <b class="logo-icon p-l-10">
                    ...
                    <!-- Dark Logo icon -->
                    <img src="{{ url('admin/assets/images/logo-icon.png') }}" alt="homepage" class="light-logo" />
                ...
                <span class="logo-text">
                    <!-- dark Logo text -->
                    <img src="{{ url('admin/assets/images/logo-text.png') }}" alt="homepage" class="light-logo" />
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{ url('admin/assets/images/users/1.jpg') }}" alt="user" class="rounded-circle"
                            width="31"></a>
