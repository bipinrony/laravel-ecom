                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{ Storage::url($product->feature_image) }}" alt="Image">
                        </div>
                        @foreach ($product->productImage as $productImg)
                            <div class="carousel-item">
                                <img class="w-100 h-100" src="{{ Storage::url($productImg->product_image) }}"
                                    alt="Image">
                            </div>
                        @endforeach
                    </div>
            ...
            <div class="col">
                <div class="owl-carousel related-carousel">
                    @foreach ($bottomProducts as $bottomProduct)
                        <a href="{{ route('product', [$bottomProduct->slug]) }}">
                            <div class="card product-item border-0">
                                <div
                                    class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                    <img class="img-fluid w-100" src="{{ Storage::url($bottomProduct->feature_image) }}"
                                        alt="">
                                </div>
                                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                    <h6 class="text-truncate mb-3">{{ $bottomProduct->name }}</h6>
                                    <div class="d-flex justify-content-center">
                                        <h6>${{ $bottomProduct->price }}</h6>
                                        <h6 class="text-muted ml-2"><del>${{ $bottomProduct->sale_price }}</del></h6>
                                    </div>
                                </div>
